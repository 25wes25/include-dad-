...
template <class Type>
/**
 * @brief The Vector class - the templated vector class that is used mainly as a
 * way to store all of the shape pointers that will be drawn on the canvas
 * this was given to us in class; with little modification to some of the functions
 * works very similar to the STL vector
 */
class Vector
{
    private:
