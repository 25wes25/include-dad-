...
/**
 * @brief The newnew class - this is the new login window
 * it handles creating new users as well as checking already
 * exsisting users via the userObject object containg a vector of all
 * the exsisting users
 */
...
public:
    ...
    /**
     * @brief startMovie - function call to play the gif animation
     * @param gif
     */
