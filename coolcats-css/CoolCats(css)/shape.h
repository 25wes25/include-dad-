...
/**
 * @brief The Shape class - base abstract class-parent to all other shape
 * classes-holds all of the private data types that change or access pen/brush
 * attributes; is also what is held in the shape vector class
 */
class Shape
{
    private:
    ...
    public:
        ...
        /**
         * @brief move - handles moving the shape and recieves in mouse input
         * @param xy
         */
        ...
        /**
         * @brief Draw - draws the shape: virtual
         * @param paintArea
         */
