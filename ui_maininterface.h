...
public:
    ...
    void retranslateUi(QMainWindow *MainInterface)
    {
        ...
        actionTBD->setText(QApplication::translate("MainInterface", "Resize Canvas", Q_NULLPTR));
        ...
        actionExit->setShortcut(QApplication::translate("MainInterface", "Esc", Q_NULLPTR));
